...
const RandomCategoriesCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 2. Gọi API tạo danh mục
      const res = await categoriesService.createRandomCategories({
        ...formData,
        image: imageUrl,
      });
      ...
      console.error("Lỗi tạo danh mục random", error);
      toast.error(error.response?.data?.message || "Lỗi tạo danh mục random");
    } finally {
      setLoading(false);
    }
  };
    ...
    <>
      <div className="page-header-admin">
        <div className="page-title-admin">
          <h4>THÊM DANH MỤC RANDOM ACCOUNTS</h4>
          <span>Tạo danh mục random accounts mới</span>
        </div>
      </div>
      <div className="card">
...
export default RandomCategoriesCreate;
