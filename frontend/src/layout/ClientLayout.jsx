...
import { Outlet, Link, NavLink, useMatch, useLocation } from "react-router-dom";
...
export default function ClientLayout() {
  ...
  return (
    <>
      <div
        className={`client-layout ${config.hideFooterOnMobile ? "hide-footer-mobile" : ""}`}
      >
        {/* Header */}
        ...
        {/* End Header */}
        <div className={`container ${config.containerClass || ""}`}>
